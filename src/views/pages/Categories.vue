...
<template>
  <div id="data-list-list-view" class="data-list-container">
    ...
    <categories-sidebar :isSidebarActive="addNewDataSidebar" @closeSidebar="toggleDataSidebar" :data="sidebarData" />
...
export default {
  ...
  methods: {
    ...
    deleteData (tr) {
      this.$store.dispatch('deleteCategory', tr._id).catch(err => { console.error(err) })
    },
    editData (data) {
